...
contract MyLandContract
{
    ...
    function addLand(string memory _location, uint _cost, uint _landID) public isOwner
    {
    ...
    function verifyLand(address _landHolder, uint _landID) view public returns (string memory, uint , address)
    {
